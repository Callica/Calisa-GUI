...
local GUI = script:FindFirstChild("gui") or game:GetService("CoreGui"):FindFirstChild("gui") or LocalPlayer:WaitForChild("PlayerGui"):FindFirstChild("CalisaGUI")
...
local Teleport = loadstring(game:HttpGet("https://raw.githubusercontent.com/Callica/Calisa-GUI/main/modules/target/Teleport.lua"))()
